...
def train(net, epoch):
    ...
    for i, data in enumerate(train_loader,0):
        ...
        total_mag += magnitude.sum().item()

        l = loss(outputs, labels) + magnitude
        l = l.mean()
        l.backward()
        optimizer.step()
    ...
    mag_list.append(total_mag/total)
